...
class SentimentModel:
    ...
    def _load_model(self):
        try:
            ...
            raise Exception(f'Model not found at {config.MODEL_PATH}')
    ...
    def predict(self, review):
        ...
        try:
            ...
            preprocessor = ReviewPreprocessor(lookup_table=lookup_table,
    ...
    def _get_lookup_table(self):
        try:
            ...
            return table_creator.read_from_path(config.LOOKUP_TABLE_PATH)
        except Exception as e:
            logger.exception(
                f'An error occurred reading LookupTable from {config.LOOKUP_TABLE_PATH}. ')
